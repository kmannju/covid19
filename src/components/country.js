                                ...
                                {this.state.afctdCountries.map((afctcontri) => {
                                    return (
                                        <li className="sidebar-item"> 
                                            <a className="sidebar-link" href="ticket-list.html" aria-expanded="false">
                        ...
                        <div className="page-breadcrumb">
                            <div className="row">
                                <div className="col-7 align-self-center text-left">
                                    <h3 className="page-title text-truncate text-dark font-weight-medium mb-1">Corona {this.props.match.params.country} Stats</h3>
                        ...
                        <div className="card-group">
                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="d-flex d-lg-flex d-md-block align-items-center">
                                        <div>
                                            <h2 className="text-dark mb-1 font-weight-medium">{this.state.iStats.recovered_cases}</h2>
                        ...
                        <div className="card-group">
                            <div className="card border-right">
                                <div className="card-body">
                                    <div className="d-flex d-lg-flex d-md-block align-items-center">
                                        <div>
                                            <div className="d-inline-flex align-items-center">
                                                <h2 className="text-dark mb-1 font-weight-medium">{this.state.iStats.critical_cases}</h2>
                                            </div>
                            ...
                            <div className="card border-right">
                                <div className="card-body">
                                    <div className="d-flex d-lg-flex d-md-block align-items-center">
                                        <div>
                                            <h2 className="text-dark mb-1 w-100 text-truncate font-weight-medium">{this.state.iStats.new_deaths}</h2>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="card">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center mb-4">
                                            <h4 className="card-title">Timeline <small>({this.props.match.params.country})</small></h4>
                                        </div>
